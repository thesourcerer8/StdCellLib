...
my_pwell_block = (46, 21) # Defines areas where no well implants are allowed PWL:=NOT(NWell OR PWellBlock)
...
min_spacing = {
    ...
    (l_ndiffusion, l_pdiffusion): 210*nm, # Act.b
    ...
    (l_pwell_block, l_ndiffusion): 240*nm,
    ...
    # hack for making bulk work
    (l_pdiff_contact, l_ndiffusion): 220*nm, # M1.e
    (l_ndiff_contact, l_pdiffusion): 220*nm, # M1.e
}
...
transistor_offset_y = 430*nm # 380 seems to be the minimum but it causes some violations with larger cells, 430 should do it, more might be useful against congestions, not sure what the upper limit is
...
minimum_enclosure = {
    ...
    (l_nwell, l_pdiffusion): 310*nm, # NW.c
    (l_nwell, l_ndiffusion): 240*nm, # NW.e
    #Setting l_pwell, l_pdiffusion enclosure to NW.e is
    #a hack for making the guard rings work.
    (l_pwell, l_pdiffusion): 240*nm, # NW.e
